%Evolving Optimal Granular System (eOGS) - for function approximation or prediction
%By: Daniel Leite
...
V = 2900;                %Legth of the time-window: useful for parameter adaptation and deleting
...
MaxSingError = 0.13;    %(1) Maximum estimation error (RMSE) - Range: [0,1]
MaxGranError = 0.5;     %(2) Maximum estimation error (GEI) - Range: [0,1]
MinSp = 0.6;            %(3) Minimum specificity - Range: [0,1]
MaxNoRules = 10;        %(4) Maximum number of rules - Range: [0,1]
...
Data = xlsread('Parkinsons');

%X = Data;                   %Non-normalized inputs and output
X = [Data(:,7) Data(:,12) Data(:,18:22)]; %Non-normalized inputs and output
